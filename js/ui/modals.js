import { ACTIVE_MODAL_ID, setActiveModalId } from '../core/state.js';
...
export function closeModal(id){
  ...
  if(ACTIVE_MODAL_ID===id){const open=getOpenModals();setActiveModalId(open.length?open[open.length-1].id:"");}
