...
document.getElementById("node-color-mode-select").addEventListener("change",e=>{setNodeColorMode(e.target.value);renderGroundingLegend();if(plotInited&&activeTab==="plot"){renderPlot();}});
