...
import { buildWAGroundingGraphArtifact } from './wa-graph-export.js';
...
export function updateDerivedArtifactsReady(){setArtifactReady("raw_terms",buildRawTermsArtifact());setArtifactReady("evidence",buildEvidenceArtifact());setArtifactReady("wa_grounding_graph",buildWAGroundingGraphArtifact());}
